  ...
  , bmak = {
    ...
    gd: function() {
        var a = bmak["uar"]()
          , t = "" + bmak["ab"](a)
          , e = bmak["start_ts"] / 2
          , n = window["screen"] ? 1440 : -1   // 宽
          , o = window["screen"] ? 804 : -1  // 高
          , m = window["screen"] ? 1440 : -1 // 宽
          , r = window["screen"] ? 900 : -1  //高
        ...
        bmak["bc"](),
        bmak["bmisc"](),
        a + ",uaend," + bmak["xagg"] + "," + bmak["psub"] + "," + "zh-CN" + "," + bmak["prod"] + "," + "3" + "," + bmak["pen"] + "," + bmak["wen"] + "," + bmak["den"] + "," + bmak["z1"] + "," + bmak["d3"] + "," + n + "," + o + "," + m + "," + r + "," + i + "," + c + "," + b + "," + bmak["bd"]() + "," + t + "," + s + "," + e + ",loc:" + bmak["loc"]
    },
    ...
    bd: function() {
        ...
        var k = "function" != typeof navigator["vibrate"] ? 1 : 0;  //查看设备是否有震动
        a["push"]("vib:" + k);
        var s = "function" != typeof navigator["getBattery"] ? 1 : 0;  //查看设备是否有电量
        a["push"]("bat:" + s);
    ...
    bpd: function() {
        ...
        try {
            ...
            var n = bmak["gd"]()
              , o = window["DeviceOrientationEvent"] ? "do_dis" : "do_en"
              , m = window["DeviceMotionEvent"] ? "dm_dis" : "dm_en"
...
function(a) {
    ...
    t["data"] = function() { // canvas计算错误， 正确：
        var a = screen["colorDepth"] ? screen["colorDepth"] : -1
          ...
          , r = "default";
        return r = bmak["runFonts"] ? bmak["altFonts"] ? t["fonts_optm"]():"dis" : t["fonts"](),
    ...
    t["pluginInfo"] = function() {   // 检测浏览器使用的插件。
    ...
    ,
    t["canvas"] = function() {   //canvas 图片存在问题，无法获取最正确的值  snkrs图片通过css修改过后，本地canvas绘画无法正确
        try {
            ...
            if (!t["sf4"]()) {
                ...
                "function" == typeof e["getContext"]) {
                    ...
                    n["stroke"]();
                    // var o = e["toDataURL"]();
                    var o = "data:image/png;base64,"
                    a = 0;
                    ...
                    for (var c = "data:image/png;base64,", b = 0, d = 0; d < c["length"]; d++) {
...
// bmak["pd"](!0)
// bmak.bpd()
result = bmak.sensor_data
client.set('cookie', result, (err, data) => {
    if (err == null) {
        process.exit(1);        
    }
});
